...
- **Kanon migracija ekrana** — ✅ Quests + ✅ Home + ✅ Venue sheet shipovani 2026-07-19 (AB tokeni u osTheme; VENUE lock redosled očuvan, acid Check-in identitet). Sledeći: Heat → Profile → Matches (§9 promptovi u AFTERBEFORE_DESIGN.md).
