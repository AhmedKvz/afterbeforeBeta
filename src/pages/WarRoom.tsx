...
import { WarRoomSuggestions, WarRoomPopup } from '@/components/WarRoomSuggestions';
  ...
  return (
    <div className="os-scroll" style={{ minHeight: '100vh', background: OS.bgDeep, color: OS.ink, fontFamily: "'Inter',system-ui,sans-serif", overflowY: 'auto' }}>
      ...
      <div style={{ padding: '16px 16px 60px', maxWidth: 720, margin: '0 auto' }}>
        ...
        {tab === 'venues' && (<><WarRoomPopup /><WarRoomSuggestions /><WarRoomVenues /></>)}
        ...
        {tab === 'docs' && (
          <Section label="DOKUMENTI · RESURSI">
            {[
              ...
              { t: '🎲 Zavrti noć — igra velikih', u: `${REPO}/ZAVRTI-NOC.md`, d: 'Točak · Šifra · Crew Šifra — mehanike, brave, B1 momenti' },
